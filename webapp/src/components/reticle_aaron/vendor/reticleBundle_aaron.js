...
function render(w){
  const html=`<div class="page">
    ...
    <main class="col">
      ...
      ${sec('predictions','pred','Predicted functions','STRING + DepMap','<div class="load" id="pred-body">Inferring candidate functions from associations…</div>')}
      ...
      ${sec('coess','eviq','Co-essentiality','RETICLE · BioGRID ORCS','<div id="coess-body" style="color:var(--faint);font-family:var(--mono);font-size:12px">Looking for co-essential partners…</div>')}
